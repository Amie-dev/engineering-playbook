...
compartmentB.splice(3, 1, "Storekeeper");       // replace Iyer Ji
console.log(compartmentB); // [ 'Sharma Ji', 'Khan Sahab', 'Gupta Ji', 'Storekeeper' ]
...
console.log(roster.includes("Storekeeper"));   // false
