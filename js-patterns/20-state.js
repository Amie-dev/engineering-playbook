...
// ────────────────────────────────────────────────────────────
// BLOCK 1 — Classic State Pattern (Beverage Vending Machine)
// ────────────────────────────────────────────────────────────

console.log("=== BLOCK 1: Beverage Vending Machine ===");
...
let vm = new BeverageVendingMachine();
let masalaTea = { name: "Masala Tea", price: 15 };

vm.selectItem(masalaTea);
vm.insertCoin(10);
vm.selectItem(masalaTea);
vm.insertCoin(10);
vm.selectItem(masalaTea);
