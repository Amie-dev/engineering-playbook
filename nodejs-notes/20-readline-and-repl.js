...
// ============================================================
// STORY: Tech Cafe Counter
// Ramu Bhaiya runs a tech cafe counter. He takes orders (lines of
...
const beverageOrders = [
  ...
  'REGULAR: Normal coffee, two cups',
  'SPECIAL: Sulaimani tea with lemon!'
];

const rl1 = readline.createInterface({
  input: Readable.from(beverageOrders.map(l => l + '\n')),
...
async function runBlock2() {
  ...
  const tapriAlerts = [
    'BEVERAGE_SPILL customer=Sharma_ji table=3',
