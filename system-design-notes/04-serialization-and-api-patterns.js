...
// A JSON request leaves your phone for coffee payment -- readable
...
encoder.encodeString(3, "storekeeper@paytm");
...
const mobileResp = {
  ...
  recentTxns: [{ amount: "Rs 30", to: "Coffee" }, { amount: "Rs 500", to: "Flipkart" }],
};
const webResp = {
  user: { id: 1, name: "Arjun", email: "arjun@email.com", vpa: "arjun@phonepe" },
  balance: { amount: 15000, currency: "INR" },
  transactions: [{ id: 101, amount: 30, to: "Coffee" }, { id: 102, amount: 500, to: "Flipkart" }],
